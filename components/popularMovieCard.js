...
function PopularMovieCard({ movie, deleteMovie, updateMovie }) {
        ...
        <div className="flex flex-col w-1/2 space-y-4">
          <div className="flex flex-col justify-between items-start">
            ...
            <div className="mt-4 flex items-center space-x-4">
              ...
              <button
                onClick={updateMovie}
                className="bg-yellow-400 font-bold rounded-xl p-2 mt-4 text-black"
              >
                Update
              </button>
              <button
                onClick={deleteMovie}
                className="bg-red-600 font-bold rounded-xl p-2 mt-4 text-black"
              >
                Delete
              </button>
            </div>
